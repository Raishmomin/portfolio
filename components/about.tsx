...
export function About() {
  ...
  const highlights = [
    ...
    },
    {
      ...
      description:
        "Experienced with MongoDB, PostgreSQL, and database optimization",
    },
    {
      icon: Cloud,
      title: "DevOps & Cloud",
      description:
        "Skilled in CI/CD, Docker, AWS, and infrastructure automation",
    },
  ];
  ...
  return (
    <section
      id="about"
      className="sm:py-24 py-10 bg-white dark:bg-gray-950 relative overflow-hidden"
    >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-base sm:text-lg text-gray-600 dark:text-gray-300 mb-4 sm:mb-6 leading-relaxed">
                  Started my development journey {value?.personalData[0]?.experience || ""} years ago with a passion for
                  creating digital solutions. I've worked on various projects
                  ranging from small business websites to large-scale enterprise
                  applications.
                </p>
                <p className="text-base sm:text-lg text-gray-600 dark:text-gray-300 mb-4 sm:mb-6 leading-relaxed">
                  Recently expanded my skill set to include DevOps practices,
                  enabling me to handle the complete software development
              ...
              <div className="space-y-8">
                <div className="bg-white dark:bg-gray-900 rounded-2xl sm:p-8 p-2 shadow-lg hover:shadow-xl transition-all">
                  <div className="flex justify-between items-center mb-6">
                    <span className="text-gray-700 dark:text-gray-300 font-medium text-lg">
                      Experience
                    </span>
                    <span className="sm:text-3xl text-lg font-bold bg-gradient-to-r from-blue-600 to-violet-600 bg-clip-text text-transparent">
                      {value?.personalData[0]?.experience || ""} Years
                    </span>
                  </div>
